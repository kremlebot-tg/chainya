...
d.text((X, 250), "У каждого чая", font=prata(58), fill=INK)
d.text((X, 322), "свой характер", font=prata(58), fill=RED)

d.text((X, 452), "Меню с вкусовыми профилями,", font=golos(26), fill=(190, 183, 174))
d.text((X, 488), "бронь стола и чай навынос.", font=golos(26), fill=(190, 183, 174))
